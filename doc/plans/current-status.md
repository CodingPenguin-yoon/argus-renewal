...
- 제품 고도화: KIS 현물 반응 운영 관찰, 뉴스 source 품질 보정, 판단 엔진 가중치 정교화, 매크로 실제 source 결정.
...
3. 뉴스 source 품질과 중요도 감점 키워드를 운영 로그 기준으로 보정합니다.
4. KOSPI200 시장 전체 선물 수급 endpoint는 공식 문서나 live smoke로 확인되기 전까지 보류합니다.
